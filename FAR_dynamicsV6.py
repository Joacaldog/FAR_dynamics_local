...
def run_dynamics(i):
    ...
    os.system(f"source {in_folder}/amber.sh")
    ...
    print(f'---------------------------------------\nRunning minimizations and calculating binding affinity within TMUX...')
    # tmux_send_gpu = f'export CUDA_VISIBLE_DEVICES={gpu_num}'
    ...
    # os.system(f'tmux send-keys -t {rep_folder} "source amber.sh" C-m')
    ...
    #     os.system(bindingE_cmd)
    # os.system(f'tmux kill-session -t {rep_folder}')
    # print(f'In the meantime you can check the files at {rep_folder}')
